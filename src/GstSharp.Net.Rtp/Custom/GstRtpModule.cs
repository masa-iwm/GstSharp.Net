...
/// </summary>
internal static partial class GstRtpModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstRtp</c> imports
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstRtpModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstRtp", CreateEntries()));
    }
}
