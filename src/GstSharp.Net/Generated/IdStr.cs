...
public sealed unsafe partial class IdStr : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstIdStr</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static IdStr Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstIdStr</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private IdStr(Gst.Interop.Borrowed borrowed)
