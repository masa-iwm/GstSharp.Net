...
public sealed unsafe partial class TagList : Gst.MiniObject
{
    ...
    /// <summary>Wraps a <c>GstTagList</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static TagList Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstTagList</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The mini object that is lent to managed code.</param>
    private TagList(Gst.Interop.Borrowed borrowed)
        : base(borrowed)
    {
    }
    ...
    public Gst.TagScope GetScope()
    {
        ...
        Gst.TagScope result = (Gst.TagScope)nativeResult;
        System.GC.KeepAlive(this);
        return result;
    }
