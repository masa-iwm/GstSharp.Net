...
/// <summary>A fundamental type that describes an unordered list of #GValue</summary>
/// <remarks>
/// <para>
/// Functions of the fundamental type <c>GST_TYPE_LIST</c>.
...
/// </para>
/// </remarks>
public static unsafe partial class ValueList
{
    ...
    public static void AppendValue(ref Gst.GObject.Value value, in Gst.GObject.Value appendValue)
    {
        ...
        fixed (Gst.GObject.GValueNative* valuePointer = &value.NativeValue)
        {
            ...
            {
                GstValueListAppendValue(valuePointer, appendValuePointer);
            }
        }
    }
    ...
    public static void Concat(out Gst.GObject.Value dest, in Gst.GObject.Value value1, in Gst.GObject.Value value2)
    {
        ...
        fixed (Gst.GObject.GValueNative* destPointer = &dest.NativeValue)
        {
            fixed (Gst.GObject.GValueNative* value1Pointer = &System.Runtime.CompilerServices.Unsafe.AsRef(in value1).NativeValue)
            {
                ...
                {
                    GstValueListConcat(destPointer, value1Pointer, value2Pointer);
                }
            }
        }
    }
    ...
    public static uint GetSize(in Gst.GObject.Value value)
    {
        ...
        {
            uint nativeResult = GstValueListGetSize(valuePointer);
            return nativeResult;
        }
    }
    ...
    public static Gst.GObject.Value GetValue(in Gst.GObject.Value value, uint index)
    {
        ...
        fixed (Gst.GObject.GValueNative* valuePointer = &System.Runtime.CompilerServices.Unsafe.AsRef(in value).NativeValue)
        {
            nint nativeResult = GstValueListGetValue(valuePointer, index);
    ...
    public static void Init(ref Gst.GObject.Value value, uint prealloc)
    {
        fixed (Gst.GObject.GValueNative* valuePointer = &value.NativeValue)
        {
            GstValueListInit(valuePointer, prealloc);
        }
    }
    ...
    /// <paramref name="value2"/> is empty.
    /// </exception>
    public static void Merge(out Gst.GObject.Value dest, in Gst.GObject.Value value1, in Gst.GObject.Value value2)
    {
        dest = default;
        if (value1.IsEmpty)
        {
        ...
        fixed (Gst.GObject.GValueNative* destPointer = &dest.NativeValue)
        {
            fixed (Gst.GObject.GValueNative* value1Pointer = &System.Runtime.CompilerServices.Unsafe.AsRef(in value1).NativeValue)
            {
                fixed (Gst.GObject.GValueNative* value2Pointer = &System.Runtime.CompilerServices.Unsafe.AsRef(in value2).NativeValue)
                {
                    GstValueListMerge(destPointer, value1Pointer, value2Pointer);
                }
            }
        }
    }
    ...
    public static void PrependValue(ref Gst.GObject.Value value, in Gst.GObject.Value prependValue)
    {
        ...
        fixed (Gst.GObject.GValueNative* valuePointer = &value.NativeValue)
        {
            ...
            {
                GstValueListPrependValue(valuePointer, prependValuePointer);
            }
        }
    }

    /// <summary>The <c>gst_value_list_append_value</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_append_value")]
    private static partial void GstValueListAppendValue(Gst.GObject.GValueNative* value, Gst.GObject.GValueNative* appendValue);

    /// <summary>The <c>gst_value_list_concat</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_concat")]
    private static partial void GstValueListConcat(Gst.GObject.GValueNative* dest, Gst.GObject.GValueNative* value1, Gst.GObject.GValueNative* value2);

    /// <summary>The <c>gst_value_list_get_size</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_get_size")]
    private static partial uint GstValueListGetSize(Gst.GObject.GValueNative* value);

    /// <summary>The <c>gst_value_list_get_value</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_get_value")]
    private static partial nint GstValueListGetValue(Gst.GObject.GValueNative* value, uint index);

    /// <summary>The <c>gst_value_list_init</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_init")]
    private static partial void GstValueListInit(Gst.GObject.GValueNative* value, uint prealloc);

    /// <summary>The <c>gst_value_list_merge</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_merge")]
    private static partial void GstValueListMerge(Gst.GObject.GValueNative* dest, Gst.GObject.GValueNative* value1, Gst.GObject.GValueNative* value2);

    /// <summary>The <c>gst_value_list_prepend_value</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_value_list_prepend_value")]
    private static partial void GstValueListPrependValue(Gst.GObject.GValueNative* value, Gst.GObject.GValueNative* prependValue);
}
