...
public sealed unsafe partial class CapsFeatures : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstCapsFeatures</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static CapsFeatures Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstCapsFeatures</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private CapsFeatures(Gst.Interop.Borrowed borrowed)
