...
public sealed unsafe partial class Uri : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstUri</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static Uri Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstUri</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private Uri(Gst.Interop.Borrowed borrowed)
    ...
    public Gst.Uri Copy()
    {
        ...
        Gst.Uri result = Gst.Uri.FromNative(nativeResult, Gst.Interop.Transfer.Full)
    ...
    /// </returns>
    public System.Collections.Generic.Dictionary<string, string?>? GetMediaFragmentTable()
    {
        nint nativeResult = GstUriGetMediaFragmentTable(Handle);
    ...
    /// </returns>
    public System.Collections.Generic.Dictionary<string, string?>? GetQueryTable()
    {
        nint nativeResult = GstUriGetQueryTable(Handle);
        System.Collections.Generic.Dictionary<string, string?>? result = Gst.Interop.HashTableMarshal.ToStringDictionary(nativeResult, unref: true);
        System.GC.KeepAlive(this);
        return result;
    }
    ...
    /// </param>
    /// <returns>%TRUE if the new table was successfully used for the query table.</returns>
    public bool SetQueryTable(System.Collections.Generic.IReadOnlyDictionary<string, string?>? queryTable)
    {
        using Gst.Interop.HashTableScope queryTableScope = Gst.Interop.HashTableMarshal.Alloc(queryTable);
        int nativeResult = GstUriSetQueryTable(Handle, queryTableScope.Handle);
        bool result = nativeResult != 0;
        System.GC.KeepAlive(this);
        return result;
    }
    ...
    /// <summary>The <c>gst_uri_get_media_fragment_table</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_uri_get_media_fragment_table")]
    private static partial nint GstUriGetMediaFragmentTable(nint uri);
    ...
    /// <summary>The <c>gst_uri_get_query_table</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_uri_get_query_table")]
    private static partial nint GstUriGetQueryTable(nint uri);
    ...
    /// <summary>The <c>gst_uri_set_query_table</c> entry point.</summary>
    [LibraryImport("Gst", EntryPoint = "gst_uri_set_query_table")]
    private static partial int GstUriSetQueryTable(nint uri, nint queryTable);
