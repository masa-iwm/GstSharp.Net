...
public sealed unsafe partial class Message : Gst.MiniObject
{
    ...
    /// <summary>Wraps a <c>GstMessage</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static Message Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstMessage</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The mini object that is lent to managed code.</param>
    private Message(Gst.Interop.Borrowed borrowed)
        : base(borrowed)
    {
    }
