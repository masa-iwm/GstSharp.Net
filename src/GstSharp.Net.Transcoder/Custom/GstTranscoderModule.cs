...
/// </summary>
internal static partial class GstTranscoderModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstTranscoder</c> imports
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstTranscoderModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstTranscoder", CreateEntries()));
    }
}
