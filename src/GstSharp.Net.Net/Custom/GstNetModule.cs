...
/// </summary>
internal static partial class GstNetModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstNet</c> imports of this
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstNetModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstNet", CreateEntries()));
    }
}
