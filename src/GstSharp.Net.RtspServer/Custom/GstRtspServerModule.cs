...
/// </summary>
internal static partial class GstRtspServerModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstRtspServer</c> imports
    /// of this assembly resolve through it, and hands the type table of the
    /// module to <see cref="TypeRegistry"/>.
    /// </summary>
    /// <remarks>
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstRtspServerModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstRtspServer", CreateEntries()));
    }
}
