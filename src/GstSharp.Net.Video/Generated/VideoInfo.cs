...
public sealed unsafe partial class VideoInfo : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstVideoInfo</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static VideoInfo Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstVideoInfo</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private VideoInfo(Gst.Interop.Borrowed borrowed)
