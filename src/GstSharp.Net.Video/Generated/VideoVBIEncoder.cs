...
public sealed unsafe partial class VideoVBIEncoder : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstVideoVBIEncoder</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static VideoVBIEncoder Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstVideoVBIEncoder</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private VideoVBIEncoder(Gst.Interop.Borrowed borrowed)
