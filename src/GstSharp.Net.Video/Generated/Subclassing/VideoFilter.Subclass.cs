...
public unsafe partial class VideoFilter
{
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ClassConfig> configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : VideoFilter, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GstVideoFilter</c> does not derive from, an interface is declared
    ...
    private static int SetInfoTrampoline(nint filter, nint incaps, nint inInfo, nint outcaps, nint outInfo)
    {
        try
        {
            if (Gst.GObject.Object.TryGetOrFabricate(filter) is not VideoFilter managed)
            {
    ...
    private static int TransformFrameIpTrampoline(nint trans, nint frame)
    {
        try
        {
            if (Gst.GObject.Object.TryGetOrFabricate(trans) is not VideoFilter managed)
            {
