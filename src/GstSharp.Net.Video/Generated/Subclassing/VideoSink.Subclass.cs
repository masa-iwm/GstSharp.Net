...
public unsafe partial class VideoSink
{
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ClassConfig> configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : VideoSink, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GstVideoSink</c> does not derive from, an interface is declared
    ...
    private static int ShowFrameTrampoline(nint videoSink, nint buf)
    {
        try
        {
            if (Gst.GObject.Object.TryGetOrFabricate(videoSink) is not VideoSink managed)
            {
