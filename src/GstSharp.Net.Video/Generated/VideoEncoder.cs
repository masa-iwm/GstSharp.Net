...
public abstract unsafe partial class VideoEncoder : Gst.Element, Gst.IPreset
{
    ...
    /// <summary>Answers a copy of the <c>input_segment</c> field of <c>GstVideoEncoder</c>.</summary>
    /// <remarks>
    /// <para>
    ...
    public Gst.Segment GetInputSegment()
    {
        Gst.Segment value = Gst.Segment.FromNative(
            Handle + Gst.Video.VideoEncoderOwnFieldsRaw.OwnOffset + Gst.Video.VideoEncoderOwnFieldsRaw.InputSegmentOffset,
            Gst.Interop.Transfer.None)
            ?? throw new System.InvalidOperationException("The 'input_segment' field of GstVideoEncoder is null.");
        System.GC.KeepAlive(this);
        return value;
    }

    /// <summary>Answers a copy of the <c>output_segment</c> field of <c>GstVideoEncoder</c>.</summary>
    /// <remarks>
    /// <para>
    /// The structure is embedded in the instance this wrapper points at. What comes
    /// back is a copy of it that the caller owns and disposes, so it stays good after
    ...
    {
        Gst.Segment value = Gst.Segment.FromNative(
            Handle + Gst.Video.VideoEncoderOwnFieldsRaw.OwnOffset + Gst.Video.VideoEncoderOwnFieldsRaw.OutputSegmentOffset,
            Gst.Interop.Transfer.None)
            ?? throw new System.InvalidOperationException("The 'output_segment' field of GstVideoEncoder is null.");
        System.GC.KeepAlive(this);
        return value;
    }
