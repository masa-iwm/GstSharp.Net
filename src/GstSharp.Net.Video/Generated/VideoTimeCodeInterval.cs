...
public sealed unsafe partial class VideoTimeCodeInterval : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstVideoTimeCodeInterval</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static VideoTimeCodeInterval Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstVideoTimeCodeInterval</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private VideoTimeCodeInterval(Gst.Interop.Borrowed borrowed)
