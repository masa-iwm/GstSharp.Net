...
public sealed unsafe partial class VideoOverlayRectangle : Gst.MiniObject
{
    ...
    /// <summary>Wraps a <c>GstVideoOverlayRectangle</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static VideoOverlayRectangle Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstVideoOverlayRectangle</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The mini object that is lent to managed code.</param>
    private VideoOverlayRectangle(Gst.Interop.Borrowed borrowed)
        : base(borrowed)
    {
    }
