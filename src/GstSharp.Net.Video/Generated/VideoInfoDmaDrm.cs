...
public sealed unsafe partial class VideoInfoDmaDrm : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstVideoInfoDmaDrm</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static VideoInfoDmaDrm Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstVideoInfoDmaDrm</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private VideoInfoDmaDrm(Gst.Interop.Borrowed borrowed)
