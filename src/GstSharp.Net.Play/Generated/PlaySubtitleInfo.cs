...
/// <summary>#GstPlayStreamInfo specific to subtitle streams.</summary>
public unsafe partial class PlaySubtitleInfo : Gst.Play.PlayStreamInfo
{
    /// <summary>Wraps a native <c>GstPlaySubtitleInfo</c>.</summary>
    ...
    /// <c>GstPlaySubtitleInfo</c> and has no binding of its own here. See
    ...
    /// </para>
    /// </remarks>
    protected PlaySubtitleInfo(nint handle, Gst.Interop.Transfer transfer)
        : base(handle, transfer)
    {
    }

    /// <summary>The <c>gst_play_subtitle_info_get_language</c> function.</summary>
    ...
    [LibraryImport("GstPlay", EntryPoint = "gst_play_subtitle_info_get_language")]
    private static partial nint GstPlaySubtitleInfoGetLanguage(nint info);

    /// <summary>Returns the <c>GType</c> that GObject registered <c>GstPlaySubtitleInfo</c> under.</summary>
    /// <returns>The type of the instances of this wrapper.</returns>
    [LibraryImport("GstPlay", EntryPoint = "gst_play_subtitle_info_get_type")]
    ...
    internal static new object CreateWrapper(nint handle, Gst.Interop.Transfer transfer) => new PlaySubtitleInfo(handle, transfer);
}
