...
/// </summary>
internal static partial class GstAppModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstApp</c> imports of
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstAppModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstApp", CreateEntries()));
    }
}
