...
public sealed unsafe partial class AppSinkSimpleCallbacks : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstAppSinkSimpleCallbacks</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static AppSinkSimpleCallbacks Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstAppSinkSimpleCallbacks</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private AppSinkSimpleCallbacks(Gst.Interop.Borrowed borrowed)
