...
/// <summary>Base class for single-media sources</summary>
public unsafe partial class Source : GES.TrackElement, GES.IExtractable, GES.IMetaContainer
{
    /// <summary>Wraps a native <c>GESSource</c>.</summary>
    ...
    /// <c>GESSource</c> and has no binding of its own here. See
    ...
    /// </para>
    /// </remarks>
    protected Source(nint handle, Gst.Interop.Transfer transfer)
        : base(handle, transfer)
    {
    }

    /// <summary>Returns the <c>GType</c> that GObject registered <c>GESSource</c> under.</summary>
    /// <returns>The type of the instances of this wrapper.</returns>
    [LibraryImport("GES", EntryPoint = "ges_source_get_type")]
    ...
    internal static new object CreateWrapper(nint handle, Gst.Interop.Transfer transfer) => new Source(handle, transfer);
}
