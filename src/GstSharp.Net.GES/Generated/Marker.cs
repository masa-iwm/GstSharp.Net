...
public unsafe partial class Marker : Gst.GObject.Object, GES.IMetaContainer
{
    ...
    /// <c>GESMarker</c> and has no binding of its own here. See
    ...
    /// </para>
    /// </remarks>
    protected Marker(nint handle, Gst.Interop.Transfer transfer)
        : base(handle, transfer)
    {
    }

    /// <summary>Current position (in nanoseconds) of the #GESMarker</summary>
    /// <remarks>
    /// <para>
    ...
    public ulong Position
    {
        get
        {
            using Gst.GObject.Value holder = GetProperty("position");
