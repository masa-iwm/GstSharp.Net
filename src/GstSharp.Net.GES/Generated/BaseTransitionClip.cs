...
/// <summary>The <c>GESBaseTransitionClip</c> class.</summary>
public abstract unsafe partial class BaseTransitionClip : GES.OperationClip, GES.IExtractable, GES.IMetaContainer
{
    /// <summary>Wraps a native <c>GESBaseTransitionClip</c>.</summary>
    ...
    /// <c>GESBaseTransitionClip</c> and has no binding of its own here. See
    ...
    /// </para>
    /// </remarks>
    protected BaseTransitionClip(nint handle, Gst.Interop.Transfer transfer)
        : base(handle, transfer)
    {
    }

    /// <summary>Returns the <c>GType</c> that GObject registered <c>GESBaseTransitionClip</c> under.</summary>
    /// <returns>The type of the instances of this wrapper.</returns>
    [LibraryImport("GES", EntryPoint = "ges_base_transition_clip_get_type")]
    ...
    /// <summary>
    /// The wrapper of a native type that derives from <c>GESBaseTransitionClip</c> and has no
    /// generated binding of its own, for example an element of a plugin.
    /// </summary>
    private sealed class Concrete : BaseTransitionClip
    {
