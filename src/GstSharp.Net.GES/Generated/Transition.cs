...
/// <summary>Base class for media transitions.</summary>
public abstract unsafe partial class Transition : GES.Operation, GES.IExtractable, GES.IMetaContainer
{
    /// <summary>Wraps a native <c>GESTransition</c>.</summary>
    ...
    /// <c>GESTransition</c> and has no binding of its own here. See
    ...
    /// </para>
    /// </remarks>
    protected Transition(nint handle, Gst.Interop.Transfer transfer)
        : base(handle, transfer)
    {
    }

    /// <summary>Returns the <c>GType</c> that GObject registered <c>GESTransition</c> under.</summary>
    /// <returns>The type of the instances of this wrapper.</returns>
    [LibraryImport("GES", EntryPoint = "ges_transition_get_type")]
    ...
    /// <summary>
    /// The wrapper of a native type that derives from <c>GESTransition</c> and has no
    /// generated binding of its own, for example an element of a plugin.
    /// </summary>
    private sealed class Concrete : Transition
    {
