...
/// <content>The subclassing surface of <c>GESBaseEffectClip</c>.</content>
public unsafe partial class BaseEffectClip
{
    /// <summary>
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESBaseEffectClip</c>.</exception>
    protected BaseEffectClip(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESBaseEffectClip</c> with GObject.</summary>
    ...
    /// class that <c>GESBaseEffectClip</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : BaseEffectClip, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESBaseEffectClip</c> does not derive from, an interface is declared
