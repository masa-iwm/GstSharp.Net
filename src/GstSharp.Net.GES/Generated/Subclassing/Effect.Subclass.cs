...
/// <content>The subclassing surface of <c>GESEffect</c>.</content>
public unsafe partial class Effect
{
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESEffect</c>.</exception>
    protected Effect(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESEffect</c> with GObject.</summary>
    ...
    /// class that <c>GESEffect</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : Effect, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESEffect</c> does not derive from, an interface is declared
