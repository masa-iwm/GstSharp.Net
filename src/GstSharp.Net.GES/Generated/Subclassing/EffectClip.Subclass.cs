...
/// <content>The subclassing surface of <c>GESEffectClip</c>.</content>
public unsafe partial class EffectClip
{
    /// <summary>
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESEffectClip</c>.</exception>
    protected EffectClip(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESEffectClip</c> with GObject.</summary>
    ...
    /// class that <c>GESEffectClip</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : EffectClip, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESEffectClip</c> does not derive from, an interface is declared
