...
/// <content>The subclassing surface of <c>GESOperationClip</c>.</content>
public unsafe partial class OperationClip
{
    /// <summary>
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESOperationClip</c>.</exception>
    protected OperationClip(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESOperationClip</c> with GObject.</summary>
    ...
    /// class that <c>GESOperationClip</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : OperationClip, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESOperationClip</c> does not derive from, an interface is declared
