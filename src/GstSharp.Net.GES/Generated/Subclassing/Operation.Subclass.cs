...
/// <content>The subclassing surface of <c>GESOperation</c>.</content>
public unsafe partial class Operation
{
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESOperation</c>.</exception>
    protected Operation(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESOperation</c> with GObject.</summary>
    ...
    /// class that <c>GESOperation</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : Operation, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESOperation</c> does not derive from, an interface is declared
