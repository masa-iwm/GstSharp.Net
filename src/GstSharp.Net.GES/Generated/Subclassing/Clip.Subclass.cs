...
public unsafe partial class Clip
{
    ...
    /// description and must never be null (ges-effect-asset.c:390-391 dereferences it) - which
    /// owns the only reference to the element until ges_container_add takes one of its own
