...
/// <content>The subclassing surface of <c>GESSourceClip</c>.</content>
public unsafe partial class SourceClip
{
    /// <summary>
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESSourceClip</c>.</exception>
    protected SourceClip(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESSourceClip</c> with GObject.</summary>
    ...
    /// class that <c>GESSourceClip</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : SourceClip, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESSourceClip</c> does not derive from, an interface is declared
