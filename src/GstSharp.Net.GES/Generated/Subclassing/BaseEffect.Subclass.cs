...
/// <content>The subclassing surface of <c>GESBaseEffect</c>.</content>
public unsafe partial class BaseEffect
{
    /// <summary>
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESBaseEffect</c>.</exception>
    protected BaseEffect(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESBaseEffect</c> with GObject.</summary>
    ...
    /// class that <c>GESBaseEffect</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : BaseEffect, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESBaseEffect</c> does not derive from, an interface is declared
