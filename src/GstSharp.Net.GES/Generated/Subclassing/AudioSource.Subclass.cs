...
/// <content>The subclassing surface of <c>GESAudioSource</c>.</content>
public unsafe partial class AudioSource
{
    ...
    /// <exception cref="System.ArgumentException">The instance is not a <c>GESAudioSource</c>.</exception>
    protected AudioSource(Gst.GObject.SubclassCtorArgs args)
        : this(args.HandleFor(GetGType()), args.Transfer)
    {
    }

    /// <summary>Registers a managed subclass of <c>GESAudioSource</c> with GObject.</summary>
    ...
    /// class that <c>GESAudioSource</c> does not derive from.
    /// </exception>
    ...
    public static new Gst.GObject.SubclassType DefineSubclass<TSelf>(
        ...
        Action<Gst.GObject.ObjectClassConfig>? configureClass,
        params Gst.GObject.VfuncOverride[] overrides)
        where TSelf : AudioSource, Gst.GObject.IManagedSubclass<TSelf> =>
    ...
    /// class that <c>GESAudioSource</c> does not derive from, an interface is declared
