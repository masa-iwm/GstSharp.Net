...
/// <summary>
/// The entry point of the <c>GstPbutils</c> binding: it initialises
...
/// application that reaches for <c>Gst.Pbutils</c> only in a cast or a type
/// test,
/// which is exactly what <c>element is Discoverer</c> is, therefore never
/// executes a line
...
/// </para>
/// </remarks>
public static class GstPbutils
{
    /// <summary>
