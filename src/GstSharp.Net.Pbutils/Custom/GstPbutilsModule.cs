...
/// </summary>
internal static partial class GstPbutilsModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstPbutils</c> imports of
    /// this assembly resolve through it, and hands the type table of the module
    /// to <see cref="TypeRegistry"/>.
    /// </summary>
    /// <remarks>
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstPbutilsModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstPbutils", CreateEntries()));
    }
}
