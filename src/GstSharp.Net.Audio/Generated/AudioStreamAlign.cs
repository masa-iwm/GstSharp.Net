...
public sealed unsafe partial class AudioStreamAlign : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstAudioStreamAlign</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static AudioStreamAlign Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstAudioStreamAlign</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private AudioStreamAlign(Gst.Interop.Borrowed borrowed)
