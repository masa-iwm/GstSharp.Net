...
/// <summary>
/// The entry point of the <c>GstAudio</c> binding: it initialises GstSharp.Net
...
/// application that reaches for <c>Gst.Audio</c> only in a cast or a type test,
/// which is exactly what <c>sink is AudioBaseSink</c> is, therefore never
/// executes a line
