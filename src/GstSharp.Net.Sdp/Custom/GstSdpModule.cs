...
/// </summary>
internal static partial class GstSdpModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstSdp</c> imports of
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstSdpModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstSdp", CreateEntries()));
    }
}
