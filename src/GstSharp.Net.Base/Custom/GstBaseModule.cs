...
/// </summary>
internal static partial class GstBaseModule
{
    /// <summary>
    /// Runs before any code of this assembly: it hooks
    /// <see cref="NativeLoader"/> up, so that the <c>GstBase</c> imports of
    ...
    {
        NativeLoader.EnsureRegistered(typeof(GstBaseModule).Assembly);
        TypeRegistry.RegisterModule(new NativeModule("GstBase", CreateEntries()));
    }
}
