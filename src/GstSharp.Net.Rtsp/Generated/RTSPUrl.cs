...
public sealed unsafe partial class RTSPUrl : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstRTSPUrl</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static RTSPUrl Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstRTSPUrl</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private RTSPUrl(Gst.Interop.Borrowed borrowed)
