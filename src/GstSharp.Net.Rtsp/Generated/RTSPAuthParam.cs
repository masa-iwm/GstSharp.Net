...
public sealed unsafe partial class RTSPAuthParam : Gst.GObject.Boxed
{
    ...
    /// <summary>Wraps a <c>GstRTSPAuthParam</c> that GStreamer keeps owning, for the length of one call.</summary>
    ...
    /// </remarks>
    internal static RTSPAuthParam Borrow(nint handle) => new(new Gst.Interop.Borrowed(handle));

    /// <summary>Wraps a <c>GstRTSPAuthParam</c> the caller keeps owning.</summary>
    /// <param name="borrowed">The value that is lent to managed code.</param>
    private RTSPAuthParam(Gst.Interop.Borrowed borrowed)
