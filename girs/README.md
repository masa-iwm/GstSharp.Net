...
| File | Source |
| --- | --- |
| `Gst-1.0.gir`, `GstBase-1.0.gir`, `GstApp-1.0.gir`, `GstVideo-1.0.gir`, `GstAudio-1.0.gir`, `GstPbutils-1.0.gir`, `GstNet-1.0.gir`, `GstSdp-1.0.gir`, `GstRtsp-1.0.gir`, `GstRtp-1.0.gir`, `GstRtspServer-1.0.gir`, `GstWebRTC-1.0.gir`, `GstAllocators-1.0.gir`, `GstTag-1.0.gir`, `GstTranscoder-1.0.gir`, `GstPlay-1.0.gir`, `GES-1.0.gir` | GStreamer monorepo, `girs/` directory, commit `2d3e05cbdad68e47d645f548899b432dc9fb4473` ("Release 1.28.6", 2026-08-05). Linux flavor. |
...
for m in Gst-1.0 GstBase-1.0 GstApp-1.0 GstVideo-1.0 GstAudio-1.0 GstPbutils-1.0 \
         GstNet-1.0 GstSdp-1.0 GstRtsp-1.0 GstRtp-1.0 GstRtspServer-1.0 \
         GstWebRTC-1.0 GstAllocators-1.0 GstTag-1.0 GstTranscoder-1.0 \
         GstPlay-1.0 GES-1.0; do
...
* Every one of the seventeen GStreamer girs starts with the `<!-- This file was
