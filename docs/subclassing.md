...
answer exactly that below a pad type that adds nothing of its own, `FlowReturn.Ok`
and `false`, instead of throwing; below a native pad class that does fill the
