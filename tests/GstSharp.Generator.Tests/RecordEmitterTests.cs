...
public sealed class RecordEmitterTests
{
    ...
    [Theory]
    [InlineData("GstSharp.Net", 126)]
    [InlineData("GstSharp.Net.Base", 39)]
    [InlineData("GstSharp.Net.App", 8)]
    [InlineData("GstSharp.Net.Audio", 52)]
    [InlineData("GstSharp.Net.Video", 81)]
    ...
    public void TheRecordCensusIsStable()
    {
        ...
        // 54 opaque records emit 33 files. Twelve more since the subclassing
        // surface landed: six class struct mirrors, their registry, and the
        // five `*.Subclass.cs` partials of Gst.Element, Gst.Bin, Gst.Pad,
        // Gst.DeviceProvider and Gst.Device.
        Assert.Equal(126, files.Count);
