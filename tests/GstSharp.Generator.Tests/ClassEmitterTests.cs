...
public sealed class ClassEmitterTests
{
    ...
    [InlineData("GES", 56, 2, 2, 0, 3, 382, 77, 39, 7)]
    ...
    [Theory]
    [InlineData("Gst", 1, 90, 53, 117, 43, 10)]
    ...
    [Theory]
    [InlineData("Gst", 27, 0, 21, 0, 0, 5, 60)]
