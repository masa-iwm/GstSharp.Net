...
public sealed class ClassEmitterTests
{
    ...
    [Theory]
    [InlineData("Gst", 35, 49, 5, 39, 18, 1446, 29, 23, 71)]
    ...
    [InlineData("GstRtspServer", 19, 6, 0, 8, 0, 382, 58, 40, 21)]
    ...
    [InlineData("GstRtspServer", 2, 1, 1, 3, 17, 0)]
    ...
    public void EveryGeneratedClassOpensItsConstructorAndEveryRecordDoesNot()
    {
        ...
        // Nineteen more since the subclassing surface landed: the
        ...
        // holds nineteen classes - fourteen from stage 2a and the five codec
        // bases of stage 2b.
        Assert.Equal(209, classes);
